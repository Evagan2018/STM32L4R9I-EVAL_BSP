/******************************************************************************
 * @file     vio_STM32L4R9I-EVAL.c
 * @brief    Virtual I/O implementation for board STM32L4R9I-EVAL
 * @version  V1.0.0
...
/*! \page vio_STM32L4R9I-EVAL Physical I/O Mapping

The table below lists the physical I/O mapping of this CMSIS-Driver VIO implementation.

| Virtual I/O   | Variable       | Board component      | Pin
|:--------------|:---------------|:---------------------|:------
| vioBUTTON0    | vioSignalIn.0  | Wake-up button (B3)  | PC13
| vioLED0       | vioSignalOut.0 | LED red        (LD3) | PH14
| vioLED1       | vioSignalOut.1 | LED green      (LD1) | PB15
| vioLED2       | vioSignalOut.2 | LED blue       (LD4) | PH15
| vioLED3       | vioSignalOut.3 | LED orange     (LD2) | PH13
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTH(14), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED1,    GPIO_PIN_ID_PORTB(15), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED2,    GPIO_PIN_ID_PORTH(15), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED3,    GPIO_PIN_ID_PORTH(13), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
